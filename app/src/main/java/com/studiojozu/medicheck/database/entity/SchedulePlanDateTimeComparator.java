 ...
 */
public class SchedulePlanDateTimeComparator implements Comparator<Map<ColumnBase, IDbType>> {
    ...
    @Override
    public int compare(Map<ColumnBase, IDbType> scheduleRecord1, Map<ColumnBase, IDbType> scheduleRecord2) {
    ...
    private int compareDate(Map<ColumnBase, IDbType> scheduleRecord1, Map<ColumnBase, IDbType> scheduleRecord2) {
    ...
    private int compareTime(Map<ColumnBase, IDbType> scheduleRecord1, Map<ColumnBase, IDbType> scheduleRecord2){
    ...
    private int compareMedicineId(Map<ColumnBase, IDbType> scheduleRecord1, Map<ColumnBase, IDbType> scheduleRecord2){
    ...
    private TimeModel getTimeModel(Map<ColumnBase, IDbType> scheduleRecord){
        int timetableId1 = (Integer) scheduleRecord.get(ScheduleEntity.COLUMN_TIMETABLE_ID).getDbValue();
        Map<ColumnBase, IDbType> timeTable1 = _timetableEntity.findTimetable(_context, timetableId1);
